...
FRONTEND_OBJ_BASENAMES_posttoken := preprocess/tokens/PPTokenizer preprocess/tokens/PostTokenPipeline
FRONTEND_OBJ_BASENAMES_ppexpr := preprocess/tokens/PPTokenizer preprocess/expressions/ControlExpression
FRONTEND_OBJ_BASENAMES_preproc := preprocess/tokens/PPTokenizer preprocess/tokens/PostTokenPipeline preprocess/expressions/ControlExpression preprocess/Preprocessor
FRONTEND_OBJ_BASENAMES_cppgm++ := preprocess/tokens/PPTokenizer preprocess/tokens/PostTokenPipeline preprocess/expressions/ControlExpression preprocess/Preprocessor syntax/Parser syntax/SyntaxArena syntax/SyntaxTree syntax/SemanticTypes syntax/CallSemantics
